...
export class CommitParser {
	...
	/**
	 * Parse a commit log with the following format:
	 * ```txt
	...
	parseReferences(line: string, outReferences: CommitReference[]) {
		/**
		 * We want to first check if the line contains a action reference pattern
		 * if
		 */
	...
	/**
	 * Parse the raw commit message for mentions and references
	 */
